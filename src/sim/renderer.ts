...
import type { Organism, Structure, Biome, Remains, KnowledgeNode, StructureType } from './types';
...
export function render(
  ...
  const scaleX = width / sim.settings.worldWidth;
  const scaleY = height / sim.settings.worldHeight;
